...
custom_objects_roberta = {'TFBertModel': TFRobertaModel}
...
def analyze_roberta(input_text):
    loaded_model = tf.keras.models.load_model('../dashboard/Model/model_roberta.h5',
                                            custom_objects=custom_objects_roberta)
    tokenizer_roberta = RobertaTokenizerFast.from_pretrained('roberta-base-uncased')
